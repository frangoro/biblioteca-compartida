...
mongoose.connect('mongodb://localhost/biblioteca-compartida', { useNewUrlParser: true, useUnifiedTopology: true })
  .then(() => {
...
//TODO: Eliminar la BD si existe para recrearla cada vez que se ejecute el script
